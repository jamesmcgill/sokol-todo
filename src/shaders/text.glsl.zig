...
//
//    Cmdline:
//        sokol-shdc -i src/shaders/text.glsl -o src/shaders/text.glsl.zig -l glsl430:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
//    Shader program: 'text':
...
pub const ATTR_text_color0 = 1;
pub const ATTR_text_texcoord0 = 2;
...
//
//
const vs_source_glsl430 = [378]u8 {
...
//    void main()
//    {
//        frag_color = color * vec4(1.0, 1.0, 1.0, texture(tex_smp, uv).x);
//    }
//
//
const fs_source_glsl430 = [263]u8 {
    ...
    0x6c,0x6f,0x72,0x20,0x2a,0x20,0x76,0x65,0x63,0x34,0x28,0x31,0x2e,0x30,0x2c,0x20,
    0x31,0x2e,0x30,0x2c,0x20,0x31,0x2e,0x30,0x2c,0x20,0x74,0x65,0x78,0x74,0x75,0x72,
...
//
//
const fs_source_glsl300es = [273]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
    ...
    0x2e,0x30,0x2c,0x20,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x28,0x74,0x65,0x78,0x5f,
    0x73,0x6d,0x70,0x2c,0x20,0x75,0x76,0x29,0x2e,0x78,0x29,0x3b,0x0a,0x7d,0x0a,0x0a,
    0x00,
};
//
...
//    void frag_main()
//    {
//        frag_color = color * float4(1.0f, 1.0f, 1.0f, tex.Sample(smp, uv).x);
//    }
//
//    SPIRV_Cross_Output main(SPIRV_Cross_Input stage_input)
//    {
...
const fs_source_hlsl5 = [627]u8 {
    ...
    0x2a,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x28,0x31,0x2e,0x30,0x66,0x2c,0x20,0x31,
    0x2e,0x30,0x66,0x2c,0x20,0x31,0x2e,0x30,0x66,0x2c,0x20,0x74,0x65,0x78,0x2e,0x53,
    0x61,0x6d,0x70,0x6c,0x65,0x28,0x73,0x6d,0x70,0x2c,0x20,0x75,0x76,0x29,0x2e,0x78,
...
//    {
//        main0_out out = {};
//        out.frag_color = in.color * float4(1.0, 1.0, 1.0, tex.sample(smp, in.uv).x);
//        return out;
//    }
//
//
const fs_source_metal_macos = [461]u8 {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
    ...
    0x63,0x6f,0x6c,0x6f,0x72,0x20,0x2a,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x28,0x31,
    0x2e,0x30,0x2c,0x20,0x31,0x2e,0x30,0x2c,0x20,0x31,0x2e,0x30,0x2c,0x20,0x74,0x65,
...
//      var sampled : vec4f;
//      let x_24 : vec2f = uv;
//      let x_25 : vec4f = textureSample(tex, smp, x_24);
//      sampled = vec4f(1.0f, 1.0f, 1.0f, x_25.x);
//      let x_34 : vec4f = color;
//      let x_35 : vec4f = sampled;
//      frag_color = (x_34 * x_35);
//      return;
//    }
//
//    struct main_out {
...
const fs_source_wgsl = [728]u8 {
    ...
    ,
