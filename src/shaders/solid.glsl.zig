...
//
//    Cmdline:
//        sokol-shdc -i src/shaders/solid.glsl -o src/shaders/solid.glsl.zig -l glsl430:metal_macos:hlsl5:glsl300es:wgsl -f sokol_zig --reflection
//
//    Overview:
//    =========
...
//
pub const ATTR_solid_position = 0;
pub const ATTR_solid_color0 = 1;
...
pub fn solidAttrSlot(attr_name: []const u8) ?usize {
...
pub fn solidImageSlot(img_name: []const u8) ?usize {
    _ = img_name;
    return null;
}
pub fn solidSamplerSlot(smp_name: []const u8) ?usize {
    _ = smp_name;
    return null;
}
pub fn solidUniformblockSlot(ub_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        return 0;
    }
    return null;
}
pub fn solidUniformblockSize(ub_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        return @sizeOf(VsParams);
    }
    return null;
}
pub fn solidUniformOffset(ub_name: []const u8, u_name: []const u8) ?usize {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
...
pub fn solidUniformDesc(ub_name: []const u8, u_name: []const u8) ?sg.GlslShaderUniform {
    if (std.mem.eql(u8, ub_name, "vs_params")) {
        if (std.mem.eql(u8, u_name, "mvp")) {
...
pub fn solidStoragebufferSlot(sbuf_name: []const u8) ?usize {
    _ = sbuf_name;
    return null;
}
